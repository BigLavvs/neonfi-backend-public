...
-- ::text cast required when running via Prisma $queryRawUnsafe — Prisma cannot
-- deserialize the composite record type that create_hypertable returns natively.
-- Direct psql / pgAdmin can omit the cast.
